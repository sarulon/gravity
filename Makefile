...
PLANET_TAG := 7.1.5-$(K8S_VER_SUFFIX)
...
robotest-run-suite:
	./build.assets/robotest/run_robotest.sh pr $(shell pwd)/upgrade_from

.PHONY: robotest-run-nightly
robotest-run-nightly:
	./build.assets/robotest/run_robotest.sh nightly $(shell pwd)/upgrade_from
